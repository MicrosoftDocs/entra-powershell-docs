...
>[!NOTE]
>You will notice a new Service Principal in your tenant when you enable DirSync for the first time or reenable DirSync on an existing tenant. This new service principal is of appId 6bf85cfa-ac8a-4be5-b5de-425a0d0dc016 and its display name is Microsoft Entra AD Synchronization Service.
