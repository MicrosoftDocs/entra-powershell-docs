...
Connect to Microsoft Entra with at least an [External Identity Provider Administrator][-external-identity-provider-admin] role.
...
Iterate over each guest user to check for expiration.
